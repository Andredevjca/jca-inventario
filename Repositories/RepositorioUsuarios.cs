...
{
    public Task<CredenciaisUsuario?> ObterCredenciaisAsync(SqlConnection conexao, string email)
    {
    ...
    public Task<CredenciaisUsuario?> ObterAtivoAsync(SqlConnection conexao, int id)
    {
        return conexao.QuerySingleOrDefaultAsync<CredenciaisUsuario>(
